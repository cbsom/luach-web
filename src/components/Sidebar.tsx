      ...
      <aside className={`sidebar ${isMobileOpen ? "sidebar-mobile-open" : ""}`}>
        ...
        <div className="glass-panel p-4 flex-grow flex flex-col gap-4 overflow-hidden min-h-0">
          ...
          <button
            ...
            className="mobile-add-event-btn btn-warm border rounded-xl py-3 px-4 flex items-center justify-center gap-2 font-bold text-sm transition-all hover:scale-[1.02]">
            <Plus size={18} />
